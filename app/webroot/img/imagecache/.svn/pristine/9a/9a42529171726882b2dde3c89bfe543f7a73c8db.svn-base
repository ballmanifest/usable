<div class="calendarShares form">
<?php echo $this->Form->create('CalendarShare'); ?>
	<fieldset>
		<legend><?php echo __('Edit Calendar Share'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('CalendarShare.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('CalendarShare.id'))); ?></li>
