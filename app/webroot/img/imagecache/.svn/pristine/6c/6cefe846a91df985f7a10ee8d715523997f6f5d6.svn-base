<div class="notices index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('notice_type'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($notice['Notice']['notice_type']); ?>&nbsp;</td>
		<td><?php echo h($notice['Notice']['itemid']); ?>&nbsp;</td>
		<td><?php echo h($notice['Notice']['item_type']); ?>&nbsp;</td>
