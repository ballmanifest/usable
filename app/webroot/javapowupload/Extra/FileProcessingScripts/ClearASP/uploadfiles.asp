...
dim uploadsDirVar, Upload, ks, fileKey, myfile, postfiles, i, j
...
if (UBound(ks) <> -1) then	
	for each fileKey in Upload.UploadedFiles.keys
		'myfile = Upload.UploadedFiles(fileKey)
		Response.write("File " & Upload.UploadedFiles(fileKey).FileName & " uploaded success.<br>")
	next
else
