		...
		$text_after_signup = (isset($opts['form']['wpautop']) && $opts['form']['wpautop'] == 1) ? wpautop(wptexturize($text_after_signup)) : $text_after_signup;
		 ...
		 if(!isset($_POST['nsu_submit']) || count($errors) > 0) { //form has not been submitted yet 
			...
			if(isset($opts['mailinglist']['subscribe_with_name']) && $opts['mailinglist']['subscribe_with_name'] == 1) {	
				...
				$output .= "<div class=\"name\"><input class=\"name_field\" id=\"nsu-name-$formno\" type=\"text\" name=\"$name_id\" value=\"$name_value\" ";
			...
			$output .= "<div class=\"name\"><input class=\"name_field\" id=\"nsu-email-$formno\" type=\"text\" name=\"$email_id\" value=\"$email_value\" ";
			...
			$output .= "<p><input type=\"image\" src=\"http://184.172.176.24/~virtue66/clients/filocity/wp-content/themes/filocity/images/signup_btn.jpg\" id=\"nsu-submit-$formno\" class=\"nsu-submit\" name=\"nsu_submit\" value=\"$submit_button\" /></p>";
