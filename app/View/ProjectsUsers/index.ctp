<div class="projectsUsers index">
	...
	<tr>
		...
		<td>
			<?php echo $this->Html->link($projectsUser['Project']['name'], array('controller' => 'projects', 'action' => 'view', $projectsUser['Project']['id'])); ?>
		</td>
		<td>
			<?php echo $this->Html->link($projectsUser['User']['title'], array('controller' => 'users', 'action' => 'view', $projectsUser['User']['id'])); ?>
		</td>
		<td><?php echo h($projectsUser['ProjectsUser']['title']); ?>&nbsp;</td>
		<td><?php echo h($projectsUser['ProjectsUser']['created']); ?>&nbsp;</td>
		<td><?php echo h($projectsUser['ProjectsUser']['modified']); ?>&nbsp;</td>
		<td class="actions">
