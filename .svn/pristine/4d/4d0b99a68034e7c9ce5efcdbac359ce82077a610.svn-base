...
function twentyten_setup() {
	...
	register_nav_menus( array(
		'primary' => __( 'Primary Navigation', 'beauty' ),
		'Secondary' => __( 'Secondary Navigation', 'beauty' ),
	) );
	...
	define( 'HEADER_IMAGE_HEIGHT', apply_filters( 'twentyten_header_image_height', 183 ) );
...
function twentyten_widgets_init() {
	// Area 1, located at the top of the sidebar.
		...
		'name' => __( 'Copy Right Text', 'twentyten' ),
		'id' => 'copy_right',
		'description' => __( 'To add copy right text in footer', 'twentyten' ),
		'before_widget' => '',
		'after_widget' => '',
		'before_title' => '',
		'after_title' => '',
		...
		register_sidebar( array(
		'name' => __( 'Home Page Text', 'twentyten' ),
		'id' => 'home_page',
		'description' => __( 'To add text on Home Page', 'twentyten' ),
		'before_widget' => '',
		'after_widget' => '',
		'before_title' => '<h4>',
		'after_title' => '</h4>',
		...
		register_sidebar( array(
		'name' => __( 'Home Page Image', 'twentyten' ),
		'id' => 'home_image',
		'description' => __( 'To add Image on Home Page', 'twentyten' ),
		'before_widget' => '',
		'after_widget' => '',
		'before_title' => '',
		'after_title' => '',
...
function my_search_form( $form ) {
    ...
    <div class="left"><input type="text" value="' . get_search_query() . '" name="s" id="s" /></div>
    <div class="btn"><input type="image" src="images/search_btn.jpg" alt="Search" width="31" height="25" border="0" /></div>
    </div>
    </form>';
...
function show_limited_words($content, $max_length){
...
add_shortcode( 'get_popular', 'display_wmp_get_popular');
...
$files = get_children('post_parent='.get_the_ID().'&post_type=attachment&post_mime_type=image');
    ...
    print "<img src='$thumb' class='thumbnail' width=\"80\" height=\"45\" alt=\"Filocity Blog\" border=\"0\" />";

	else:
		print '<img src="'. get_bloginfo('template_directory').'/images/video_img.jpg" width="80" height="45" alt="Filocity Blog" border="0" />';
...
function new_excerpt_more($more) {
	...
	return ' <a href="'. get_permalink($post->ID) . '"></a>... '.get_the_tag_list('<p>Tags: ',', ','</p><br />').'';
