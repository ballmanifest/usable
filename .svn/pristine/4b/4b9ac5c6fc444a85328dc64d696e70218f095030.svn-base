			...
			<script type="text/javascript">
				...
				<?php if($method == 'stick'){ ?>
					...
					if(!jQuery().dcSocialSlick) {
						$.getScript('<?php echo dc_jqslicksocial::get_plugin_directory(); ?>/js/jquery.social.slick.1.0.js', function(){
				...
				<?php } else { ?>
					...
					if(!jQuery().dcSocialFloater) {
						$.getScript('<?php echo dc_jqslicksocial::get_plugin_directory(); ?>/js/jquery.social.float.1.3.js', function(){
