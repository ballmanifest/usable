<div class="comments index">
	...
	<tr>
		...
		<td>
			<?php echo $this->Html->link($comment['User']['title'], array('controller' => 'users', 'action' => 'view', $comment['User']['id'])); ?>
		</td>
		<td>
			<?php echo $this->Html->link($comment['Project']['name'], array('controller' => 'projects', 'action' => 'view', $comment['Project']['id'])); ?>
		</td>
		<td>
			<?php echo $this->Html->link($comment['Task']['title'], array('controller' => 'tasks', 'action' => 'view', $comment['Task']['id'])); ?>
		</td>
